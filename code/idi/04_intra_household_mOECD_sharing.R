...
## effects for individuals under the assumption of intra-household mOECD sharing.
...
# Select intra-household mOECD sharing records
fis_age <-
  fis_age_all[sharing_assumption == "Intra-household mOECD", .SD, .SDcols = !"sharing_assumption"]
...
intrahhold_moecd_redist_effects <- re_md[re_df, on = .(age_bin5, N)]


# Round
intrahhold_moecd_fiscal_cpts_rounded <- round_totals_and_means(intrahhold_moecd_fiscal_cpts)
intrahhold_moecd_ginis_rounded <- round_ineq_stats(intrahhold_moecd_ginis)
intrahhold_moecd_redist_effects_rounded <- round_ineq_stats(intrahhold_moecd_redist_effects)


# Output
fwrite(intrahhold_moecd_fiscal_cpts,
       file.path(OUTPUT_DIR, "intrahhold_moecd_fiscal_cpts.csv"))
fwrite(intrahhold_moecd_fiscal_cpts_rounded,
       file.path(OUTPUT_DIR, "intrahhold_moecd_fiscal_cpts_rounded.csv"))

fwrite(intrahhold_moecd_ginis,
       file.path(OUTPUT_DIR, "intrahhold_moecd_ginis.csv"))
fwrite(intrahhold_moecd_ginis_rounded,
       file.path(OUTPUT_DIR, "intrahhold_moecd_ginis_rounded.csv"))

fwrite(intrahhold_moecd_redist_effects,
       file.path(OUTPUT_DIR, "intrahhold_moecd_redist_effects.csv"))
fwrite(intrahhold_moecd_redist_effects_rounded,
       file.path(OUTPUT_DIR, "intrahhold_moecd_redist_effects_rounded.csv"))
